...
int TMVAClassification_02( TString myMethodList = "" )
{
   ...
   //
   //     mylinux~> root -l TMVAClassification_02.C\(\"myMethod1,myMethod2,myMethod3\"\)
   ...
   ///Read Root Trees
   TTree *signalTree     = (TTree*)input->Get("Dfinder/ntDkpi");
   TTree *background     = (TTree*)input->Get("Dfinder/ntDkpi");

   // Create a ROOT output file where TMVA will store ntuples, histograms, etc.
   TString outfileName( "TMVA_02.root" );
   ...
   TMVA::DataLoader *dataloader=new TMVA::DataLoader("dataset_02");
...
int main( int argc, char** argv )
{
   ...
   return TMVAClassification_02(methodList);
}
