...
auto d_select = d.Define("DPt_true","func_select_signal(DPt,DGen)") //pT
                 ...
                 .Define("D2DDecayLength_true","func_select_signal(D2DDecayLength,DGen)")// 2D projection in xy-plane of the distance between PV and SV  
                 .Define("D2DDecayLength_fake","func_select_fake(D2DDecayLength,DGen)") // 2D projection in xy-plane of the distance between PV and SV
                 .Define("DDca_true", "func_select_signal(DDca,DGen)") // Distance of closest aproach
                 .Define("DDca_fake", "func_select_fake(DDca,DGen)") //Distance of closest aproach  
                 ...
                 .Define("DTrk2PtErr_fake", "func_select_fake(DTrk2PtErr,DGen)") // 2st Daughter Pseudo-rapidity
                 .Define("DTrk2Eta_true", "func_select_signal(DTrk2Eta,DGen)") // 2st Daughter Transverse Momentum Uncertainty
                 .Define("DTrk2Eta_fake", "func_select_fake(DTrk2Eta,DGen)") // 2st Daughter Transverse Momentum Uncertainty
